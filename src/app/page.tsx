...
export default function Page() {
    return (
        <div className="bg-gray-800 min-h-screen text-white">
            ...
            <section className="relative bg-gray-900 text-white h-screen py-24 px-6">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center h-full max-w-4xl mx-auto">
                    ...
                    <p className="text-xl mb-8 max-w-2xl">
                        Nossa plataforma poderosa oferece tudo o que você precisa para gerenciar, monitorar e otimizar seus investimentos em criptomoedas. Acompanhe as flutuações, receba alertas e tome decisões inteligentes com facilidade.
                    </p>
